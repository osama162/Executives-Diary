    ...
    >
      ...
      <button
        className={`
          ...
          bg-[linear-gradient(135deg,#61a5c2,#090869)]
        ...
        `}
      >
        <span className="mr-3 text-[18px] font-semibold transition-all group-hover:tracking-wider">
          Share
        </span>
        <svg
        ...
        >
          <path
            fill="white"
            d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 
              1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 
              6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 
              1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 
              0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 
              2.92-2.92c0-1.61-1.31-2.92-2.92-2.92zM18 
              4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 
              .45-1 1-1zM6 13c-.55 0-1-.45-1-1s.45-1 
              1-1 1 .45 1 1-.45 1-1 1zm12 7.02c-.55 
      ...
      {/* Tooltip */}
      <div
        className={`absolute top-[110%] left-1/2 -translate-x-1/2 transform
          rounded-xl p-6 shadow-[0_15px_30px_rgba(0,0,0,0.2)]
          backdrop-blur-md bg-white/90
          transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)]
          ${open ? "opacity-100 scale-100 visible" : "opacity-0 scale-90 invisible"}
        `}
      >
        {/* Arrow */}
        <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[10px] border-transparent bg-transparent"></div>

        {/* Social Icons */}
        <div className="flex gap-3">
          <a
            href="#"
            className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 shadow-md transition hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:bg-[#61a5c2]"
          >
            <svg
              className="w-6 h-6 fill-gray-700 group-hover:fill-white"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
              ...
              2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 
              ...
              0-.42-.015-.63A9.935 9.935 0 0024 4.59z"></path>
            </svg>
          </a>
